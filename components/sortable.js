...
(function (addon) {
    ...
    'use strict';
    var supportsTouch = 'ontouchstart' in window || window.DocumentTouch && document instanceof DocumentTouch, supportsDragAndDrop = !supportsTouch && function () {
    ...
    UI.component('sortable', {
        ...
        init: function () {
            ...
            var handleDragStart = delegate(function (e) {
                ...
                delayIdle = {
                    ...
                    'apply': function () {
                        draggingPlaceholder = $('<div class="' + [
                            $this.options.draggingClass,
                            $this.options.dragCustomClass
                        ].join(' ') + '"></div>').css({
                            display: 'none',
                            top: offset.top,
                            left: offset.left,
                        ...
                        $this.trigger('start.uk.sortable', [
                            $this,
            ...
            var handleDrop = delegate(function (e) {
                ...
                $this.trigger('change.uk.sortable', [
                    $this,
                    currentlyDraggingElement
                ]);
            });
        ...
        moveElementNextTo: function (element, elementToMoveNextTo) {
            dragging = true;
            var $this = this, list = $(element).parent().css('min-height', ''), next = isBelow(element, elementToMoveNextTo) ? elementToMoveNextTo : elementToMoveNextTo.nextSibling, children = list.children(), count = children.length;
            ...
            children.stop().each(function () {
                var ele = $(this), offset = ele.position();
            ...
            children = list.children().each(function () {
                ...
                var ele = $(this), before = ele.data('offset-before');
                ele.css({
                    'position': 'absolute',
                    'top': before.top,
                    'left': before.left,
            ...
            children.each(function () {
                var ele = $(this), before = ele.data('offset-before'), offset = ele.data('offset-after');
