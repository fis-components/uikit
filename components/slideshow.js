...
(function (addon) {
    ...
    UI.component('slideshow', {
        ...
        init: function () {
            ...
            this.fixFullscreen = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && this.container.hasClass(UI.prefix('@-slideshow-fullscreen'));
                ...
                if (media.length) {
                    ...
                    case 'IFRAME':
                        ...
                        media.attr('src', '').on('load', function () {
                            ...
                            src.indexOf('?') > -1 ? '&' : '?',
                            'enablejsapi=1&api=1'
                        ].join('')).addClass(UI.prefix('@-position-top'));
