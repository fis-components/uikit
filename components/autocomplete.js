...
(function (addon) {
    ...
    UI.component('autocomplete', {
        ...
        pick: function (item, scrollinview) {
            var $this = this, items = UI.$(this.dropdown.find(UI.prefix('.@-autocomplete-results')).children(UI.prefix(':not(.' + this.options.skipClass + ')'))), selected = false;
        ...
        select: function () {
            ...
            this.trigger('select.uk.autocomplete', [
                data,
                this
            ]);
            if (data.value) {
