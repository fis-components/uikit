...
(function (addon) {
    ...
    UI.component('grid', {
        ...
        updateLayout: function (elements) {
            ...
            var $this = this, gutter = this.options.gutter, children = elements, maxwidth = this.element.width() + 2 * gutter + 2, left = 0, top = 0, positions = [], item, width, height, pos, aX, aY, i, z, max, size;
        ...
        filter: function (filter) {
            ...
            var children = this.element.children(), elements = {
                    'visible': [],
                    'hidden': []
                };
            children.each(function (index) {
            ...
            elements.hidden = $(elements.hidden).map(function () {
                return this[0];
            });
            elements.visible = $(elements.visible).map(function () {
                return this[0];
            });
