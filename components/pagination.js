...
(function (addon) {
    ...
    UI.component('pagination', {
        ...
        selectPage: function (pageIndex, pages) {
            ...
            this.trigger('select.uk.pagination', [
                pageIndex,
                this
            ]);
        },
        _render: function () {
            ...
            // Generate Prev link
            if (o.lblPrev)
                this._append(o.currentPage - 1, { text: o.lblPrev });
            ...
            if (o.lblNext)
                this._append(o.currentPage + 1, { text: o.lblNext });
        },
        _append: function (pageIndex, opts) {
            var $this = this, item, link, options;
            pageIndex = pageIndex < 0 ? 0 : pageIndex < this.pages ? pageIndex : this.pages - 1;
            options = $.extend({ text: pageIndex + 1 }, opts);
            item = pageIndex == this.currentPage ? '<li class="@-active"><span>' + options.text + '</span></li>' : '<li><a href="#page-' + (pageIndex + 1) + '" data-page="' + pageIndex + '">' + options.text + '</a></li>';
